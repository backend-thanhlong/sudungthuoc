...
const TEMPLATE_COLUMNS: TemplateColumn[] = [
    ...
    { header: REPORT_FIELD_NHAP_HOAN_TRA, key: REPORT_FIELD_NHAP_HOAN_TRA, width: 16, locked: false },
    ...
    { header: REPORT_FIELD_GIA_VAT, key: REPORT_FIELD_GIA_VAT, width: 10, locked: true },
    { header: REPORT_FIELD_THANH_TIEN_TON_CUOI, key: REPORT_FIELD_THANH_TIEN_TON_CUOI, width: 18, locked: false },
    { header: REPORT_FIELD_BHYT, key: REPORT_FIELD_BHYT, width: 8, locked: true },
    { header: REPORT_FIELD_DICH_VU, key: REPORT_FIELD_DICH_VU, width: 8, locked: true },
...
const INSTRUCTIONS: InstructionRow[] = [
    {
        ...
        "Định dạng/Ví dụ": "STT / Mã nội bộ / Mã thuốc / Tên thuốc / Hoạt chất / Đơn vị tính / Nhóm TCKT / Giá VAT / BHYT / Dịch vụ",
    ...
    {
        "Tên trường": "Nhập do Hoàn trả",
        "Kiểu dữ liệu": "Số",
        "Định dạng/Ví dụ": "5",
        "Ghi chú": "Số lượng nhập tăng tồn do hoàn trả trong kỳ báo cáo. Không tính vào Tổng tiền nhập.",
    },
    {
    ...
    },
    {
        ...
        "Kiểu dữ liệu": "Số",
        "Định dạng/Ví dụ": "120",
        "Ghi chú": "Công thức: Tồn đầu + Nhập trong kỳ + Nhập do Hoàn trả - Xuất trong kỳ.",
    },
    {
        "Tên trường": "Giá VAT",
        "Kiểu dữ liệu": "Số",
        "Định dạng/Ví dụ": "25000",
        "Ghi chú": "Đơn giá bao gồm VAT, lấy từ Danh mục Ánh xạ. Không chỉnh sửa trong file báo cáo.",
    },
    {
    ...
    {
        "Tên trường": "Thông tin hợp đồng",
        "Kiểu dữ liệu": "Tự động",
        "Định dạng/Ví dụ": "Số QĐ trúng thầu / Tên Công ty / Ngày bắt đầu HĐ / Ngày kết thúc HĐ",
        "Ghi chú": "Các trường này được lấy từ danh mục ánh xạ thuốc nội bộ, không nhập trong file báo cáo Xuất-Nhập-Tồn.",
    },
    {
        "Tên trường": "BHYT",
        "Kiểu dữ liệu": "Văn bản",
        "Định dạng/Ví dụ": "X",
        "Ghi chú": "Lấy từ Danh mục Ánh xạ. Muốn thay đổi phải cập nhật tại Danh mục Ánh xạ.",
    },
    {
        "Tên trường": "Dịch vụ",
        "Kiểu dữ liệu": "Văn bản",
