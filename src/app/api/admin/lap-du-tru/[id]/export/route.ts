...
export async function GET(
    ...
    try {
        ...
        const { plan, buffer, fileName } = await buildDemandPlanExportWorkbook(id);
        ...
        logActivity({
            ...
            entityId: plan.id,
            details: { planNo: plan.planNo, facilityId: plan.facilityId },
        });
        ...
        return handleRouteError(error, "Error exporting admin demand plan:");
    }
}
