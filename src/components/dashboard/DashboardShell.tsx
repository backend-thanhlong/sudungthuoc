    ...
    return (
        <div className="space-y-5">
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
                <div>
                    <h2 className="text-2xl font-bold text-gray-800">Dashboard Quản lý Dược</h2>
                    <p className="text-gray-500 text-sm mt-0.5">Phân tích và giám sát hoạt động dược toàn ngành</p>
                </div>
                <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <select
                            ...
                            className="px-3 py-2 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-400 min-w-[220px] max-w-[320px]"
                        >
            ...
            {selectedFacility !== "all" && (
                <div className="flex items-center gap-2">
                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 text-blue-700 border border-blue-200 rounded-full text-sm font-medium">
                    ...
                    <span className="text-xs text-gray-400">Đang xem dữ liệu của đơn vị này</span>
                </div>
            )}
